...
-- at runtime using the environment variable exercism_bindir.
...
-- environment variable exercism_libdir.
...
-- using the environment variable exercism_dynlibdir.
...
-- runtime using the environment variable exercism_datadir.
...
-- using the environment variable exercism_sysconfdir.
...
libdir     = "/Users/joaofelipesoares/.cabal/lib/aarch64-osx-ghc-9.12.2-inplace/exercism-0.1.0.0-inplace-exercism"
dynlibdir  = "/Users/joaofelipesoares/.cabal/lib/aarch64-osx-ghc-9.12.2-inplace"
datadir    = "/Users/joaofelipesoares/.cabal/share/aarch64-osx-ghc-9.12.2-inplace/exercism-0.1.0.0"
libexecdir = "/Users/joaofelipesoares/.cabal/libexec/aarch64-osx-ghc-9.12.2-inplace/exercism-0.1.0.0"
...
getDynLibDir  = catchIO (getEnv "exercism_dynlibdir")  (\_ -> return dynlibdir)
